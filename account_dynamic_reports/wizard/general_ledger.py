    ...
    def get_xlsx_report(self, data, response):
        ...
        if account_lines:
            for line in account_lines:
                ...
                if float(account_lines[line].get('balance')) > 0:
                    sheet.write(row_pos, 7, "Rs " + str(float(account_lines[line].get('balance'))) + " Cr", line_header)
                elif float(account_lines[line].get('balance')) == 0:
                    sheet.write(row_pos, 7, "Rs " + str(float(account_lines[line].get('balance'))), line_header)
                else:
                    sheet.write(row_pos, 7, "Rs " + str(float(account_lines[line].get('balance'))) + " Dr", line_header)
                ...
                if filter.get('include_details', False):
                    ...
                    for sub_line in sub_lines:
                        if sub_line.get('move_name') == 'Initial Balance':
                            ...
                            sheet.write(row_pos, 5, "Rs " + str(float(sub_line.get('debit'))) , line_header_light_initial)
                            sheet.write(row_pos, 6,"Rs" + str(float(sub_line.get('credit'))), line_header_light_initial)
                            if float(sub_line.get('balance')) > 0:
                                ...
                                sheet.write(row_pos, 7,"Rs " +  str(float(sub_line.get('balance'))) + " Cr", line_header_light_initial)
                            ...
                            if float(sub_line.get('balance')) > 0:
                                sheet.write(row_pos, 7, "Rs " + str(float(sub_line.get('balance'))) + " Dr",line_header_light)
                            elif float(sub_line.get('balance')) == 0:
                                sheet.write(row_pos, 7, "Rs " + str(float(sub_line.get('balance'))),line_header_light)
                            else:
                                sheet.write(row_pos, 7, "Rs " + str(float(sub_line.get('balance'))) + " Cr",line_header_light)
